...
useEffect(()=>{
  ...
  return (
    <div className="flex  min-h-screen  p-2 max-[1169px]:flex-col relative">
      <div className='w-[70%] item-center justify-center p-4 max-[1169px]:w-full '>
      <div className="card-container  flex  flex-col  w-70 h-12 [perspective:1000px] justify-center items-center mx-auto  mt-20">
     ...
     <div className='mt-2 '>
        <p className='text-white text-2xl font-semibold  max-[500px]:text-[17px] text-center  max-[785px]:text-xl max-[626px]:text-lg'>I am a passionate full stack developer with a keen interest in building dynamic and responsive web applications. I love to explore new technologies and continuously improve my skills.</p>
     </div>
...
<div className=' text-white absolute bottom-8 left-[47%] max-[500px]:left-[34%] flex flex-col justify-center items-center gap-4 max-[1169px]:bottom-[-20px] max-[1169px]:left-[44%] '>
