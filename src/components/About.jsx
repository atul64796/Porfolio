    ...
    <>
      ...
      <div className="p-6 md:p-14 flex flex-col md:flex-row justify-center md:justify-evenly flex-wrap text-white gap-8 max-w-7xl mx-auto">
        ...
        <div className="border border-gray-600 p-6 md:p-10 w-full md:w-5/12 flex flex-col gap-4 rounded-lg">
          <h1 className="text-3xl md:text-4xl font-bold text-green-500">Education</h1>
          <h2 className="text-lg md:text-xl font-semibold ">
            Bachelor of Computer Applications (BCA)
          </h2>
          <h3 className="text-base md:text-lg">2023 – 2027 (ongoing)</h3>
        ...
        {/* Experience Section */}
        <div className="border border-gray-600 p-6 md:p-10 w-full md:w-5/12 flex flex-col gap-4 rounded-lg">
          <h1 className="text-3xl md:text-4xl font-bold text-green-500">Experience</h1>
          <h2 className="text-lg md:text-xl font-semibold ">
            Web Development Intern — GAO Tek Inc.
          </h2>
          <h3 className="text-base md:text-lg">Remote | Nov 2024 – Feb 2025</h3>
          <p className="text-sm md:text-base leading-relaxed">
